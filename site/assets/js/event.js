...
(async()=>{
  ...
  if(w){
    ...
    html('[data-doctrine-title]',w.title);
    text('[data-doctrine-energy-title]',w.energyTitle);text('[data-doctrine-energy-copy]',w.energyCopy);
    text('[data-doctrine-sound-title]',w.soundTitle);text('[data-doctrine-sound-copy]',w.soundCopy);
    text('[data-doctrine-ritual-title]',w.ritualTitle);text('[data-doctrine-ritual-copy]',w.ritualCopy);
  }
